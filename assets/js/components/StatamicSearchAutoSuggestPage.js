        ...
        <div className="flex flex-wrap">
            <div className="w-full md:w-1/2">
                <div className="mx-2 mt-3">
                    <div className="react-autosuggest__parent">
                        <Autosuggest
                        ...
                        <button
                            ...
                            className="react-autosuggest__submit-button"
                        >
                            <svg
                                className="react-autosuggest__submit-button-icon"
                        ...
                        <button
                            ...
                            className="react-autosuggest__clear-button"
                            hidden=""
                        >
                            <svg
                                className="react-autosuggest__clear-button-icon"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
                                width="10"
                                height="10"
